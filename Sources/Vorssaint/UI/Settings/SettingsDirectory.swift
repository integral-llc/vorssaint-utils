    ...
    static func sections(_ s: Strings,
        ...
        return [
            ...
            (categories.utilities, [
                ...
                SettingsDirectoryItem(page: .youtubeTranscriber,
                                      title: FeatureStrings.youtubeTranscriber(language).pageTitle,
                                      icon: "text.bubble"),
                SettingsDirectoryItem(page: .layoutSwitcher,
                                      title: FeatureStrings.layoutSwitcher(language).pageTitle,
