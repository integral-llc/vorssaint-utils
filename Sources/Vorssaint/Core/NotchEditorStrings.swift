...
struct NotchEditorStrings {
    ...
    let dateCustom: String
    let dateFormatHint: String
...
extension FeatureStrings {
    static func notchEditor(_ language: AppLanguage) -> NotchEditorStrings {
        ...
        case .enUS: return NotchEditorStrings(
            ...
            dateFormat: "Format",
            dateCustom: "Custom",
            dateFormatHint: "Click a code to add it. Use | to split the text between the left and right sides, and [brackets] to show words as written.",
        ...
        case .ptBR: return NotchEditorStrings(
            ...
            dateFormatHint: "Clique em um código para adicionar. Use | para dividir o texto entre os lados esquerdo e direito e [colchetes] para mostrar palavras exatamente como foram escritas.",
        ...
        case .es: return NotchEditorStrings(
            ...
            dateFormat: "Formato",
            dateCustom: "Personalizado",
            dateFormatHint: "Pulsa un código para añadirlo. Usa | para repartir el texto entre los lados izquierdo y derecho, y [corchetes] para mostrar palabras tal cual.",
        ...
        case .de: return NotchEditorStrings(
            ...
            dateFormat: "Format",
            dateCustom: "Eigenes",
            dateFormatHint: "Zum Hinzufügen einen Code anklicken. Mit | den Text auf die linke und rechte Seite aufteilen, [eckige Klammern] zeigen Wörter unverändert an.",
        ...
        case .fr: return NotchEditorStrings(
            ...
            dateFormatHint: "Cliquez sur un code pour l’ajouter. Utilisez | pour répartir le texte entre les côtés gauche et droit, et des [crochets] pour afficher des mots tels quels.",
        ...
        case .it: return NotchEditorStrings(
            ...
            dateFormatHint: "Fai clic su un codice per aggiungerlo. Usa | per dividere il testo tra il lato sinistro e quello destro e le [parentesi quadre] per mostrare le parole così come sono.",
        ...
        case .ru: return NotchEditorStrings(
            ...
            dateFormat: "Формат",
            dateCustom: "Свой",
            dateFormatHint: "Нажмите на код, чтобы добавить его. Символ | делит текст между левой и правой сторонами, а [квадратные скобки] показывают слова как есть.",
        ...
        case .tr: return NotchEditorStrings(
            ...
            dateFormat: "Biçim",
            dateCustom: "Özel",
            dateFormatHint: "Eklemek için bir koda tıklayın. Metni sol ve sağ taraflar arasında bölmek için |, sözcükleri yazıldığı gibi göstermek için [köşeli parantez] kullanın.",
        ...
        case .ja: return NotchEditorStrings(
            ...
            dateFormat: "形式",
            dateCustom: "カスタム",
            dateFormatHint: "コードをクリックすると追加されます。| でテキストを左右に分け、[角かっこ] で文字をそのまま表示します。",
            destinations: "開く場所",
            separate: "別のウインドウ",
            feedback: "インジケータ",
            privacy: "プライバシー",
        ...
        case .ko: return NotchEditorStrings(
            ...
            dateFormat: "형식",
            dateCustom: "사용자 지정",
            dateFormatHint: "코드를 클릭하면 추가됩니다. | 기호로 텍스트를 왼쪽과 오른쪽으로 나누고, [대괄호] 안의 글자는 그대로 표시됩니다.",
            destinations: "열리는 위치",
            separate: "별도 윈도우",
            feedback: "표시기",
            privacy: "개인정보 보호",
        ...
        case .zhHans: return NotchEditorStrings(
            ...
            dateFormat: "格式",
            dateCustom: "自定义",
            dateFormatHint: "点按代码即可添加。用 | 将文字分到左右两侧，用 [方括号] 原样显示文字。",
            destinations: "打开位置",
            separate: "单独窗口",
            feedback: "提示",
            privacy: "隐私",
        ...
        case .zhTW: return NotchEditorStrings(
            ...
            dateFormat: "格式",
            dateCustom: "自訂",
            dateFormatHint: "按一下代碼即可加入。用 | 將文字分到左右兩側，用 [方括號] 原樣顯示文字。",
            destinations: "開啟位置",
            separate: "獨立視窗",
            feedback: "提示",
            privacy: "隱私",
