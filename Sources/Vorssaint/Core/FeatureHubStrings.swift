...
extension FeatureHubStrings {
    static let ko = FeatureHubStrings(
        ...
        explainFilesAndFolders: "받아쓰기가 선택한 폴더에 저장하고, WhatsApp 다운로드 정리 및 실험적 구성 기능이 다운로드 폴더를 확인할 수 있게 합니다.",
        ...
        presetEssentialDesc: "볼륨 믹서, 시스템 모니터, 절전 방지, 레이아웃 교정기 및 받아쓰기.",
...
extension FeatureHubStrings {
    static let enUS = FeatureHubStrings(
        ...
        explainFilesAndFolders: "Lets the Transcriber save to the folder you choose, and WhatsApp downloads cleanup and the experimental organizer inspect your Downloads folder.",
        ...
        presetEssentialDesc: "Volume mixer, system monitor, keep awake, layout switcher and transcriber.",
    ...
    static let ptBR = FeatureHubStrings(
        ...
        explainFilesAndFolders: "Permite que o Transcritor salve na pasta que você escolher e que a limpeza e o organizador experimental do WhatsApp verifiquem a pasta Downloads.",
        ...
        presetEssentialDesc: "Mixer de volume, monitor do sistema, manter acordado, corretor de layout e transcritor.",
    ...
    static let tr = FeatureHubStrings(
        ...
        explainFilesAndFolders: "Deşifre’nin seçtiğiniz klasöre kaydetmesini, WhatsApp temizliğinin ve deneysel düzenleyicinin İndirilenler klasörünü denetlemesini sağlar.",
        ...
        presetEssentialDesc: "Ses karıştırıcı, sistem monitörü, uyanık tutma, düzen düzeltici ve deşifre.",
    ...
    static let ru = FeatureHubStrings(
        ...
        explainFilesAndFolders: "Разрешает Расшифровке сохранять файлы в выбранную папку, а очистке и экспериментальному органайзеру WhatsApp проверять папку «Загрузки».",
        ...
        presetEssentialDesc: "Микшер громкости, системный монитор, режим без сна, переключатель раскладки и расшифровка.",
    ...
    static let es = FeatureHubStrings(
        ...
        explainFilesAndFolders: "Permite que el Transcriptor guarde en la carpeta que elijas y que la limpieza y el organizador experimental de WhatsApp examinen la carpeta Descargas.",
        ...
        presetEssentialDesc: "Mezclador de volumen, monitor del sistema, mantener despierto, corrector de distribución y transcriptor.",
    ...
    static let de = FeatureHubStrings(
        ...
        explainFilesAndFolders: "Erlaubt der Transkription, im gewählten Ordner zu sichern, und der WhatsApp-Bereinigung und dem experimentellen Organizer, den Downloads-Ordner zu prüfen.",
        ...
        presetEssentialName: "Essentials",
        presetEssentialDesc: "Lautstärkemixer, Systemmonitor, Wachhalten, Belegungskorrektur und Transkription.",
    ...
    static let fr = FeatureHubStrings(
        ...
        explainFilesAndFolders: "Autorise la Transcription à enregistrer dans le dossier choisi, et le nettoyage et l’organisateur expérimental WhatsApp à examiner le dossier Téléchargements.",
        ...
        presetEssentialDesc: "Mixeur de volume, moniteur système, maintien éveillé, correcteur de disposition et transcription.",
    ...
    static let it = FeatureHubStrings(
        ...
        explainFilesAndFolders: "Consente alla Trascrizione di salvare nella cartella scelta e alla pulizia e all’organizzatore sperimentale di WhatsApp di controllare la cartella Download.",
        ...
        presetEssentialDesc: "Mixer del volume, monitor di sistema, mantieni sveglio, correttore di layout e trascrizione.",
    ...
    static let ja = FeatureHubStrings(
        ...
        explainFilesAndFolders: "文字起こしが選んだフォルダに保存でき、WhatsAppのダウンロード整理と実験的オーガナイザーがダウンロードフォルダを確認できるようにします。",
        ...
        presetEssentialDesc: "音量ミキサー、システムモニタ、スリープ防止、レイアウト修正、文字起こし。",
    ...
    static let zhHans = FeatureHubStrings(
        ...
        explainFilesAndFolders: "允许转写保存到你选择的文件夹，并允许 WhatsApp 下载清理和实验性整理器检查下载文件夹。",
        ...
        presetEssentialDesc: "音量混音器、系统监视器、保持唤醒、布局纠正和转写。",
    ...
    static let zhTW = FeatureHubStrings(
        ...
        explainFilesAndFolders: "允許轉寫儲存到你選擇的資料夾，並允許 WhatsApp 下載項目清理和實驗性整理器檢查下載項目資料夾。",
        ...
        presetEssentialDesc: "音量混音器、系統監視器、保持喚醒、配置修正與轉寫。",
